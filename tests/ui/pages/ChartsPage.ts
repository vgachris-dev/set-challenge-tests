...
export class ChartsPage {
  ...
  constructor(page: Page) {
    ...
    this.createChartButton = page.getByRole("button", {
      name: "Create a chart",
    });
    this.nameColumnHeaderButton = page.getByRole("button", { name: "Name" });
    this.dateCreatedColumnHeaderButton = page.getByRole("button", {
      name: "Date created",
    });
    this.lastModifiedColumnHeaderButton = page.getByRole("button", {
      name: "Last modified",
    });
